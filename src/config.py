...
"""
Configuration for SHL Recommender (clean, de-duplicated + extended intents/seeds).
"""
...
# Small, optional ESCO augmentation
...
# -----------------------------------------------------------------------------
# Domain markers (diagnostics/filters)
# -----------------------------------------------------------------------------
_DOMAIN_MARKERS = {
...
RETRIEVAL_BOOST_SEEDS: Dict[str, List[str]] = {
    ...
    "product_manager": ["agile", "scrum", "jira", "confluence", "requirements", "sdlc"],
    "customer_support": [
        "contact center",
        "call center",
        "customer service",
...
# Extend tech keyword pool a bit so domain filters don't miss SHL terms
_TECH_KEYWORDS += _SHL_KEYWORDS
_DOMAIN_MARKERS["shl_general"] = _SHL_KEYWORDS

# Synonym and trigger enrichments that help the API layer
SYNONYM_MAP.update(
    {
        "assistant admin": "administrative assistant",
...
HTTP_USER_AGENT = (
    "shl-rag-recommender/1.0 (+https://shl.com; contact=genai@placeholder.com)"
)
...
# -----------------------------------------------------------------------------
# Crawl / balance constants (used by allocation + heuristics)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Slug canonicalisation (family collapsing)
# -----------------------------------------------------------------------------
